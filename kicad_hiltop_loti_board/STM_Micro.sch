...
$EndDescr
$Comp
L LoTI_Board-rescue:STM32F072RBTx-MCU_ST_STM32 U22
U 1 1 5F956EB6
P 7400 4675
...
$EndComp
$Comp
L LoTI_Board-rescue:Ferrite_Bead-device L11
U 1 1 5F957109
P 8225 2025
...
Wire Wire Line
	8525 2025 8375 2025
$Comp
L LoTI_Board-rescue:C-device C82
U 1 1 5F957430
P 7875 2250
...
$EndComp
$Comp
L LoTI_Board-rescue:C-device C73
U 1 1 5F957A1A
P 2125 1625
...
$EndComp
$Comp
L LoTI_Board-rescue:C-device C74
U 1 1 5F957BC6
P 2575 1625
...
$EndComp
$Comp
L LoTI_Board-rescue:C-device C79
U 1 1 5F957C44
P 3025 1625
...
$EndComp
$Comp
L LoTI_Board-rescue:C-device C80
U 1 1 5F957C84
P 3475 1625
...
Wire Wire Line
	4400 3075 3825 3075
$Comp
L LoTI_Board-rescue:R-device R120
U 1 1 5F95CC59
P 2725 2850
...
$EndComp
$Comp
L LoTI_Board-rescue:R-device R117
U 1 1 5F95CDB1
P 2550 3500
...
BOOT0
$Comp
L LoTI_Board-rescue:C-device C81
U 1 1 5F9616D2
P 3825 3550
...
$EndComp
$Comp
L LoTI_Board-rescue:Crystal_GND23-device Y3
U 1 1 5F964614
P 3225 6550
...
Wire Wire Line
	3575 6525 4100 6525
$Comp
L LoTI_Board-rescue:C-device C77
U 1 1 5F96D367
P 2850 6275
...
$Comp
L LoTI_Board-rescue:C-device C78
U 1 1 5F96FC00
P 2850 6825
...
$Comp
L LoTI_Board-rescue:Crystal_GND24-device Y2
U 1 1 5F97410A
P 3050 4325
...
Wire Wire Line
	3050 4075 3050 4175
$Comp
L LoTI_Board-rescue:C-device C75
U 1 1 5F97DA85
P 2825 4075
...
Wire Wire Line
	2550 4075 2675 4075
$Comp
L LoTI_Board-rescue:C-device C76
U 1 1 5F97DA93
P 2825 4625
...
$Comp
L LoTI_Board-rescue:R-device R122
U 1 1 5FA3B65A
P 11325 3075
F 0 "R122" V 11300 2850 50  0000 C CNN
F 1 "0R" V 11300 3275 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 11255 3075 50  0001 C CNN
F 3 "" H 11325 3075 50  0001 C CNN
F 4 "101-005" H 0   0   50  0001 C CNN "Devtank"
	1    11325 3075
	0    1    1    0   
$EndComp
Wire Wire Line
	11475 3075 11800 3075
$Comp
L LoTI_Board-rescue:R-device R123
U 1 1 5FA3B8E4
P 11325 3175
F 0 "R123" V 11300 2950 50  0000 C CNN
F 1 "0R" V 11300 3375 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 11255 3175 50  0001 C CNN
...
$EndComp
Wire Wire Line
	11475 3175 11800 3175
$Comp
L LoTI_Board-rescue:R-device R118
U 1 1 5FA60497
P 2675 5775
F 0 "R118" V 2650 5550 50  0000 C CNN
F 1 "0R" V 2650 5975 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 2605 5775 50  0001 C CNN
...
Wire Wire Line
	2525 5775 2200 5775
$Comp
L LoTI_Board-rescue:R-device R119
U 1 1 5FA6049E
P 2675 5875
F 0 "R119" V 2650 5650 50  0000 C CNN
F 1 "0R" V 2650 6075 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 2605 5875 50  0001 C CNN
...
$Comp
L LoTI_Board-rescue:R-device R121
U 1 1 5FA9D488
P 10925 4375
...
HS_OUT4
Text HLabel 3925 6075 0    60   Output ~ 0
HS_OUT5
Text HLabel 11800 5275 2    60   Output ~ 0
HS_OUT6
Text HLabel 11775 5575 2    60   Output ~ 0
HS_OUT7
Text HLabel 11775 5675 2    60   Output ~ 0
HS_OUT8
Text HLabel 11800 3075 2    60   BiDi ~ 0
DUT0_UART_RX_GPIO17
...
ADC0
$Comp
L LoTI_Board-rescue:R-device R124
U 1 1 5CB16726
P 12600 3575
...
$EndComp
$Comp
L LoTI_Board-rescue:LED-device D13
U 1 1 5CB1BE49
P 13075 3575
...
ADC4
Text HLabel 11800 4975 2    60   Output ~ 0
RL5
...
GPIO5
Text HLabel 11775 5875 2    60   Output ~ 0
RL4
...
ADC6
Text HLabel 3925 4975 0    60   BiDi ~ 0
GPIO8
...
ADC9
Text HLabel 3925 5375 0    60   Output ~ 0
RL2
Text HLabel 3925 5475 0    60   BiDi ~ 0
PPS1_GPIO12
Text HLabel 3925 5575 0    60   Output ~ 0
RL1
Text HLabel 3925 5675 0    60   Output ~ 0
DAC_OUT
...
Wire Wire Line
	2825 5775 4400 5775
Wire Wire Line
	10400 3175 11175 3175
Wire Wire Line
	10400 3075 11175 3075
$Comp
L LoTI_Board-rescue:Test_Point-Connector TP?
U 1 1 62481FA3
P 7100 1825
